...
class _MyFreindsState extends ConsumerState<MyFreinds> {
  ...
  pendingFreinds(Future<DocumentSnapshot<Object?>> snapshot) async {
    Map data = {};
        snapshot.then((value) => data = value.data() as Map<String, dynamic>) ;

        var userMap = data["freinds"] as Map<String, bool>;
  ...
  Widget build(BuildContext context) {
    final currentUser = ref.watch(userModelProviderState);
    ...
    final snapshot = DatabaseService.userCollection.doc(currentUser!.uid).get();
    pendingFreinds(snapshot);
                  ...
                  child: ClipRRect(
                    child:Padding(
                      ...
                      requests? Column (
                        ...
                        children :[
                          Container(
                            child: Text('Requests', style: Theme.of(context).textTheme.displaySmall),
                          ),
                      ...
                      pending ? Column (
                        children : [ 
                          Container(
                            child: Text('Pending', style: Theme.of(context).textTheme.displaySmall),
                          ),
                            ...
                            itemBuilder:
                              (context, index) {
                                ...
                                return FutureBuilder(
                                  future: DatabaseService.getUserDataByID(pendingfriends[index]),
                                    ...
                                    if(userData.connectionState == ConnectionState.done){
                                      if(userData.data != null) {
                                        ...
                                        return  ListTile(
                                          ...
                                          subtitle: Text('online', style: Theme.of(context).textTheme.titleSmall),
                                          trailing:  Row(
                      ...
                      Container(
                        child: Text('Friends', style: Theme.of(context).textTheme.displaySmall),
                      ),
                      StreamBuilder(
                        stream: DatabaseService.userCollection.doc(currentUser!.uid).snapshots(),
